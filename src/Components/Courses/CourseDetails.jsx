  ...
  return (
    <div className="bg-white dark:bg-gray-300 shadow-lg rounded-lg p-6">
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside">
          <li>Strategies to invest in international markets and global indices.</li>
          <li>Understanding currency exchange risks and hedging techniques.</li>
          <li>Analyzing emerging markets for high-growth opportunities.</li>
          <li>Applying Buffett's and Graham's value investing principles.</li>
        </ul>
      </div>
